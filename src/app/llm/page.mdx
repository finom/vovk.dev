...
Learn more about the [JSONLines Response](/jsonlines).
...
[View live example on examples.vovk.dev »](https://examples.vovk.dev/openai)
...
[View live example on examples.vovk.dev »](https://examples.vovk.dev/ai-sdk)
