...
TODO: mention safe self-inferences, openapi docs
...
Vovk.ts uses code generation, closely related to RESTful API, and uses type inference, closely related to RPC. The framework maps each RPC call onto a specially constructed URL.
