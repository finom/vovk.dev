...
- [TODO: Next.js serverless functions](/guides/serverless)
- [Build Single Page Application](/guides/spa)
...
- TODO nextjs routes
- [More info about multi-tenancy](/guides/multitenant)
...
- [LLMs: AI SDK and JSONLines](/guides/llm)
- [MCP server](/guides/mcp)
- [AI tools](/guides/ai-tools)
- [AI-powered client](/guides/ai-ui)
...
- [TODO More info about API](/guides/api)
...
**Read more**   
- [OpenAPI code generation](/guides/codegen)
...
-[OpenAPI code generation](/guides/openapi)
