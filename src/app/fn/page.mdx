...
**For LLM [function calling](/tools)**: Each procedure can be used as a "module" for LLM function calling, implemented with the `deriveTools` utility to call procedures in the current context without performing HTTP requests.
