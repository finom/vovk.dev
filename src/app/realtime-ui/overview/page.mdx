...
<Youtube src="https://www.youtube.com/embed/lQ-F6U_1niw" className='mt-2' />
...
<Image src="/screenshots/kanban-dark.png" alt="Realtime Kanban Screenshot" width={2102} height={1916} className="hidden dark:block" />
<Image src="/screenshots/kanban-light.png" alt="Realtime Kanban Screenshot" width={2104} height={1920} className="block dark:hidden" />
