...
<GithubFiles paths={['src/modules/user/UserController.ts', 'src/modules/user/UserService.ts', 'src/modules/task/TaskController.ts', 'src/modules/task/TaskService.ts']} repo="vovk-kanban-demo" />
