...
As our app is also going to support [JSONLines](/controller/jsonlines) responses for streaming data, we're going to enhance the function a bit with another `if` check.
