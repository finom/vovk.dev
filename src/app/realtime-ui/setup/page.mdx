...
```ts showLineNumbers copy filename="src/lib/fetcher.ts" repository="finom/vovk-kanban-demo"
...
```
*[The code above is fetched from GitHub repository.](https://github.com/finom/vovk-kanban-demo/blob/main/src/lib/fetcher.ts)*
