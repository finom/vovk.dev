...
```ts showLineNumbers copy filename="src/app/api/mcp/route.ts" repository="finom/vovk-kanban-demo" {30}
...
```
*[The code above is fetched from GitHub repository.](https://github.com/finom/vovk-kanban-demo/blob/main/src/app/api/mcp/route.ts)*
