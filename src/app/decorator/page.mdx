...
- `request`, which extends `VovkRequest`. It provides [req.vovk.meta](/procedure#req-vovk-meta) to get and set metadata for sharing data between decorators and the route handler.
