...
All features described in the [TypeScript](/typescript) article are available to the bundled method, including client-side validation, [custom options](/imports#fetcher), `queryKey` method and more.
