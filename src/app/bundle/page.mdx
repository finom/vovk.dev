...
The resulting bundled package will have the following structure (some extra chunks are omitted for brevity):
...
The bundle methods can be used as [LLM tools](/tools) that will invoke corresponding HTTP endpoints when called.
