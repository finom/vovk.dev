...
All features described in the [TypeScript](/typescript) article are available to the bundled [RPC modules](/rpc-module), including client-side validation, [custom options](/imports#fetcher), `queryKey` method and more.
