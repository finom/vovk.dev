...
- **Caveman-optimized prose.** Skill markdown uses a terse fragment style — articles, filler, and hedging dropped while every code block, file path, and cross-reference is preserved verbatim. ~10% fewer tokens per skill load with no loss of substance.
