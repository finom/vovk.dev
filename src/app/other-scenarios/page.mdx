...
- [Function Calling framework](/ai-tools) that turns the controllers (for server-side tools) and RPC modules (for client-side tools) into powerful agents and [MCP servers](/mcp).
