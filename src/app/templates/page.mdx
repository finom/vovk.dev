...
Overrides `outputConfig` in the root [config](/config#generatorconfig). Use this to customize the generated client (e.g., `origin`, `openAPIObject`, etc.).
