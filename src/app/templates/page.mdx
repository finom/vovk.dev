...
Overrides the `generatorConfig` option in the root of the [config](/config#generatorconfig) file. This can be used to customize the generated client for this template to use different `origin`, `openAPIObject`, etc.
