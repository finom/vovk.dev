...
<Tabs items={['npm', 'pnpm', 'yarn']}>
  <Tabs.Tab>
  ```
  npm i vovk-dto vovk-mapped-types class-validator class-transformer reflect-metadata
  ```
</Tabs.Tab>
  <Tabs.Tab>
  ```
  pnpm i vovk-dto vovk-mapped-types class-validator class-transformer reflect-metadata
  ```
  </Tabs.Tab>
  <Tabs.Tab>
  ```
  yarn add vovk-dto vovk-mapped-types class-validator class-transformer reflect-metadata
  ```
  </Tabs.Tab>
</Tabs>
