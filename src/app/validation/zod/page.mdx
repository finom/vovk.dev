...
It's implemented using the [`createStandardValidation`](./standard) function from Vovk.ts.
...
By default, Zod will target Draft 2020-12 that's not compatible with the most of today's [function calling](/function-calling) APIs, making them generate errors. If you need to pass additional options to `toJSONSchema`, you can create your own version of `withZod` function:
