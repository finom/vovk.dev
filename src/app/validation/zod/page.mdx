...
The `withZod` implementation from **vovk-zod** package uses default options for `toJSONSchema`:
...
**vovk-zod** package can be uninstalled and controllers need to use the local `withZod` instead.
