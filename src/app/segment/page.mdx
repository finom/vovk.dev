...
- Creating a [static segment](/static-segment) for OpenAPI specs, historical data, etc.
...
Whether the API is [static](/static-segment) or dynamic, you can call it with the same RPC client, including client-side validation and type inference.
