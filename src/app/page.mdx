...
<center>
A SaaS-ready API layer for Next.js — from early-stage to enterprise. Multi-tenant routing, third-party-ready APIs with generated docs and clients, and MCP-compatible AI tools, all from a single codebase.
</center>
