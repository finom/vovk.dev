...
<div className="flex justify-center gap-2 mt-6 mb-8">
  ...
  <a href="/context/realtime-ui.md">
    <img alt="Realtime Kanban Context" src="https://img.shields.io/badge/ai_context-realtime_ui.md-white" />
  </a>
</div>
...
The [Realtime Kanban](/realtime-ui) example builds a full-stack board where users, bots, AI agents, and MCP clients all update it in real time — covering state normalization, database polling, AI chat, voice AI, and Telegram integration.
