...
<img src="/vovk-logo.svg" alt="Vovk.ts Logo" className='dark:invert mx-auto clear-both'/>
...
<div className="flex justify-center gap-2 mt-6 mb-8">
  ...
  <a href="https://bundlephobia.com/package/vovk" className="hidden lg:block">
    <img alt="Bundle Size" src="https://img.shields.io/bundlephobia/minzip/vovk" />
  </a>
  <a href="https://www.npmjs.com/package/vovk">
    <img alt="NPM Version" src="https://img.shields.io/npm/v/vovk" />
  </a>
  <a href="https://github.com/finom/vovk/issues">
    <img alt="GitHub Issues" src="https://img.shields.io/github/issues/finom/vovk" />
  </a>
</div>

# Vovk.ts — Structured API Layer for Next.js


Vovk.ts is a **Next.js App Router–native back-end framework** that turns Route Handlers into a structured API layer (Controller → Service → Repository), with **first-class schema emission** and **code generation** for type-safe clients, docs, and AI tools.
