...
Define endpoints once (as real Next.js handlers), and Vovk.ts **emits schema artifacts** to **generate type-safe clients**, **publish docs**, **build AI tools**, and **mix in third-party OpenAPI schemas**—without writing and maintaining a separate contract layer.
