...
| **`vovk-client`** | Re-exported composed client | [![NPM Version](https://img.shields.io/npm/v/vovk-client)](https://www.npmjs.com/package/vovk-client) | optional |
| **`vovk-ajv`** | Client-side validation with AJV | [![NPM Version](https://img.shields.io/npm/v/vovk-ajv)](https://www.npmjs.com/package/vovk-ajv) | optional |
| **`vovk-python`** | Python client generation (experimental) | [![NPM Version](https://img.shields.io/npm/v/vovk-python)](https://www.npmjs.com/package/vovk-python) | optional |
| **`vovk-rust`** | Rust client generation (experimental) | [![NPM Version](https://img.shields.io/npm/v/vovk-rust)](https://www.npmjs.com/package/vovk-rust) | optional |
