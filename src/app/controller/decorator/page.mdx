...
- `request`, which extends [VovkRequest](/controller/request). It provides the `req.vovk.meta` method to get and set metadata for the request object to share data between decorators and the route handler.
...
export default class MyController {
  ...
  static doSomething(req) {
    ...
    console.log(meta); // Outputs: { foo: 'bar', a: 'baz', b: 1 }
    // ...
  }
}
```
