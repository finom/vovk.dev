...
**For LLM [function calling](/function-calling)**: Each controller can be used as a "module" for LLM function calling, implemented with the `deriveTools` utility to call controller methods in the current context without performing HTTP requests.
