...
On the client-side you can use any OpenAPI tooling, but it's recommended to [Scalar](https://www.npmjs.com/package/@scalar/api-reference-react) as Vovk.ts generates code snippets that can be copied directly to your codebase.
