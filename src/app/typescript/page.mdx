...
[Controllers](/controller) implemented with Vovk.ts compile to [RPC modules](/rpc-module) that share the same structure but have different argument signatures. For example, given the controller below:
