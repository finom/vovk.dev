...
- [ts](/templates#ts) - uncompiled TypeScript module with type definitions; used by default in both the [composed client](/composed) and the [segmented client](/segmented);
