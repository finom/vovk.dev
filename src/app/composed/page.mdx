...
An array of templates to use for the composed client generation. By default, it uses `["mjs", "cjs"]` templates that generate ESM and CJS modules with TypeScript definitions. The array can contain names of [built-in templates](/templates) as well as of [custom templates](/config/template-defs).
