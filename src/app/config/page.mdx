...
- `templates` - used by the [module generator](/cli/vovk-new) to define the templates for the service, controller, worker, state or any other kind of module. By default it uses templates from the [vovk-cli](/cli) package. There is no env variable to override it.
