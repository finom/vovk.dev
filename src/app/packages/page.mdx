...
The core/runtime library providing decorators, utilities, types, and other features used by both server-side and client-side code. It peer-depends only on type-focused libraries ([openapi3-ts](https://www.npmjs.com/package/openapi3-ts), [@standard-schema/spec](https://www.npmjs.com/package/@standard-schema/spec)) and is reported as 100% self-composed on [Bundlephobia](https://bundlephobia.com/package/vovk).
