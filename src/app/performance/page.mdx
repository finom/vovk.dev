...
- For high-performance workloads: split the app into multiple [segments](/segment) (e.g., serverless functions built with Next.js route.ts files), each with a manageable number of endpoints (up to 1,000).
