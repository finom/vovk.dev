import { ColdStartChart } from "./cold-start-chart.tsx";
...
- For high-performance workloads: split the app into multiple [segments](/segment) (e.g., serverless functions built with Next.js route.ts files), each with a manageable number of procedures (up to 1,000).
