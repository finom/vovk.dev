...
By default, the segmented client is generated into the **./src/client** folder (or **./client** folder if you don't use src folder) from [ts](/templates#ts) and [schemaTs](/templates#schemats) templates and for an app with multiple segments, the structure of the generated client may look like this:
...
See other options in the [Composed Client](/composed) section.