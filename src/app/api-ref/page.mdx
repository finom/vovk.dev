...
Allows you to infer the output type of the controller method or RPC method when `output` validation is used: `VovkOutput<typeof MyController.method>{:ts}` or `VovkOutput<typeof MyRPC.method>{:ts}`.

### `VovkIteration`

Allows you to infer the iteration type of the controller method or RPC method when `iteration` validation is used: `VovkIteration<typeof MyController.method>{:ts}` or `VovkIteration<typeof MyRPC.method>{:ts}`.
### `VovkBody`

Allows you to infer the type of the request input body of the controller method or RPC method when `body` validation is used: `VovkBody<typeof MyController.method>{:ts}` or `VovkBody<typeof MyRPC.method>{:ts}`.

### `VovkQuery`

Allows you to infer the type of the request query of the controller method or RPC method when `query` validation is used: `VovkQuery<typeof MyController.method>{:ts}` or `VovkQuery<typeof MyRPC.method>{:ts}`.
### `VovkParams`

Allows you to infer the type of the request params of the controller method or RPC method when `params` validation is used: `VovkParams<typeof MyController.method>{:ts}` or `VovkParams<typeof MyRPC.method>{:ts}`.
