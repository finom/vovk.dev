...
The configuration options for the generator that can be defined as root-level `outputConfig`, `outputConfig.segments[segmentName]`, `bundle.outputConfig`, or `templateDef.outputConfig` in the [config](/config) file. The actual values are resolved by the [resolveGeneratorConfigValues](#resolveoutputconfigvalues) function.
