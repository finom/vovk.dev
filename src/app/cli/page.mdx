...
- [vovk dev](/cli/vovk-dev) - runs Vovk Dev Watcher that watches for changes at controllers and updates the [schema](/schema) and the [client](/client) accordingly when needed.
...
- [vovk new](/cli/vovk-new) - module generator that helps to create segments, controllers, services and other modules that you can define as a template at [config](/config).
