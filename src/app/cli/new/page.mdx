...
**vovk-cli** provides built-in templates for controllers and services located at **templates** folder at the NPM package. Every [validation](/validation) library has its own template for controllers that's also located at **templates** folder of corresponding NPM package.
