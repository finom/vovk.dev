...
Vovk.ts is a conceptual back-end meta-framework created on top of the Next.js App Router, designed and developed by [Andrey Gubanov](https://github.com/finom). Built for efficiency and an unprecedented developer experience.
...
- [Function calling](/function-calling) framework that transforms your app into an AI agent or [JARVIS-grade real-time UI](/realtime-ui).
- [Fast](/performance).
