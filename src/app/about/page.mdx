# About (WIP)
TODO: Built on route.ts as well as NestJS built on top of Express.
TODO: controller method as a source of truth
- Server-side typing
- Server-side validation
- Client-side typing
- Client-side validation
- OpenAPI documentation snippets
- README snippets
...
- Function Calling that enables API endpoint interaction with LLMs, both on client-side and server-side. Client-side calls are particularly valuable when implementing [Realtime conversations](https://platform.openai.com/docs/realtime-conversations) through WebRTC protocol.
...
- Multitenancy support via the [multitenant](/multitenant) function applied in Next.js `middleware.ts`
