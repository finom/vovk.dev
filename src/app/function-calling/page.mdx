...
- ✨ Implement `route` option for `createLLMTools` to allow using hundreds of functions without hitting the LLM function calling limits. The routing itself can be done with vector search or other approaches.