...
Vovk.ts provides LLM function calling capabilities, turning route handlers into functions callable by AI. This enables more interactive user experiences, including interactions via a text chat interface, a [Realtime voice interface](/realtime-ui), or [MCP](/mcp).
...
import { jsonSchema, streamText, tool, convertToModelMessages, type ModelMessage, type UIMessage, type JSONSchema7 } from 'ai';
