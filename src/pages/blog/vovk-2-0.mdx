...
date: '11/05/2024'
description: 'After a long time of development and testing in multiple large projects, thanks to community feedback, Vovk 2.0 is released with some breaking changes.'
authors:
  thanhnamnguyen:
