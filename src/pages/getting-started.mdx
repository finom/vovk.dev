import BasicController from '../downloaded-examples/basic/BasicController.md';
import BasicExample from '../downloaded-examples/basic/BasicExample.md';
...
<img className="rounded-lg mt-4" src="https://github.com/finom/vovk/assets/1082083/b9e600da-a43a-4e30-a089-43e5e4b147ef" />
...
<Tabs items={['Controller', 'Component']}>
  <Tabs.Tab><BasicController /></Tabs.Tab>
  <Tabs.Tab><BasicExample /></Tabs.Tab>
</Tabs>
