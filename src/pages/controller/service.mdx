...
import BasicService from '../../downloaded-examples/basic-with-service/BasicService.md';
import BasicControllerWithService from '../../downloaded-examples/basic-with-service/BasicControllerWithService.md';
import BasicExampleWithService from '../../downloaded-examples/basic-with-service/BasicExampleWithService.md';
