...
Retrieve the OpenAPI specification from the schema and build the OpenAPI object. At this case the OpenAPI object is going to be served from the `/api` path as an example of the root endpoint.
