...
// infer query
type Query = VovkControllerQueryv<typeof UserController.updateUser>;
// infer params
...
These types are useful at [services](/services).

If you want to create a custom function that makes requests to the server, you can borrow types from the client to build the arguments.
