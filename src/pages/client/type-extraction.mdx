...
**vovk** module provides a collection of types that described at [API documentation](/api-reference). It's worthy to mention the most oftenly used types here:

```ts
import { UserController, StreamRPC } from 'vovk-client';
