...
<Image className="rounded-lg mt-5" width="300" height="286" alt="image" src="/img/about-upwork-screnshot.png" />
...
- **Iterable**: An object that can be used in a `for...of` loop. The `Symbol.iterator` method returns an Iterator object. Find out more about iterables [on MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols).
