...
- **REST**: Representational State Transfer, an architectural style for designing networked applications. A REST API uses standard HTTP methods like GET, POST, PUT, and DELETE to perform CRUD operations. Learn more about REST [here](https://restfulapi.net/).
