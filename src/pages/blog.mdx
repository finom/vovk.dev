...
import pages from './blog/_pages.json';
...
export function BlogIndex() {
  return (
      <>
        {/* Copy-paste the output to _pages.json in dev mode because of rendering bugs
        <pre>{JSON.stringify(getPagesUnderRoute("/blog"), null, 2)}</pre> 
        */}
