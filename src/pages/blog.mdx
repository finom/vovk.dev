...
<Callout type="info" emoji="ℹ️">
  Due to bugs in Nextra (the framework this documentation is built on), you may see not all blog posts here.
  <span onClick={() => window.location.reload()} className="cursor-pointer text-blue-500 underline">
    Reload the page
  </span>
