...
```ts filename="/src/modules/user/PostController.ts"
...
```ts filename="/src/modules/comment/CommentService.ts"
...
```ts filename="/src/modules/comment/CommentIsomorphicService.ts"
...
```ts filename="/src/modules/post/PostState.ts"
...
<Callout type="info" emoji="ℹ️">
  A new state management library based on static classes is [coming soon](https://github.com/finom/rebloom). 
  ...
  Stay tuned by giving it a star!
</Callout>
