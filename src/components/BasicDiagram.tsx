    ...
    <div className="mt-32">
      <div className="text-center">
        ...
        <p className="max-w-3xl mx-auto mt-2 text-secondary mb-4">
          Import and use back-end code in front-end, thanks to <code>import type</code> and <code>vovk-metadata.json</code> that contains required data to build main-thread client-side library for free.
        </p>
      </div>
