...
const BonusFeatures = () => {
  return (
    <div className="mt-24">
      <h2 className="text-center text-3xl font-semibold mb-4">That's not it!</h2>
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mx-auto max-w-screen-2xl ">
        ...
        <BonusFeaturesSection
          ...
          description={
            <>
              <p className="text-secondary">
                Creating a full-stack React-Native application has never been so easy! Set up a project with React
                Native, Next.js, and Vovk.ts, and start making requests.
              </p>
