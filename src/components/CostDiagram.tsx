    ...
    <div className="mt-32 px-5">
      <div className="text-center">
        ...
        <p className="max-w-5xl mx-auto mt-2 text-secondary mb-4">
          ...
          by up to 5%. This efficiency is achieved as developers focus on a unified code base, rather than dividing
          their attention between front-end and back-end code. Additionally, the project infrastructure becomes more
