    ...
    <div className="mt-32">
      ...
      <div className="max-w-4xl mx-auto px-5 mt-20">
        <div className="text-center">
          ...
          <p className="max-w-xl mx-auto mt-2 text-secondary">
            A Vovk.ts application is split into so-called "things" that gives (almost) a final answer on how to
...
/src/vovk
    ...
    /comment
        ...
        <p className="max-w-xl mx-auto mt-4 text-secondary text-center">
            A "thing" is either a model (user, comment, etc) or something else that can't be considered to be a model
            (auth, app settings etc). Every "thing" has its own folder with a controller, service, state, etc, where all elements are optional.
          </p>
        <div className="grid md:grid-cols-2 gap-10 mt-10">
          <div className="flex gap-4 items-start">
            ...
            <div>
              ...
              <p className="mt-1 text-secondary">
                {' '}
                Back-end Service (or just "Service") is a static class that implements third-party API calls or performs requests do the project database.
              </p>
            </div>
          </div>
          <div className="flex gap-4 items-start">
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              ...
              <p className="mt-1 text-secondary">
                {' '}
                Our plugins are supported by sponsors who provide community support. Sponsors will get email support on
                weekdays.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-4 items-start">
            ...
            <div>
              ...
              <p className="mt-1 text-secondary">
                {' '}
                We strictly follow a set of guidelines along with unit tests to make sure your implementation as easy as
                possible.{' '}
              </p>
            </div>
          </div>
